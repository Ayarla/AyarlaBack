...
{
    public abstract class AyarlaWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AyarlaWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AyarlaWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AyarlaDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AyarlaDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AyarlaDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AyarlaDbContext, Task<T>> func)
        {
            T result;
