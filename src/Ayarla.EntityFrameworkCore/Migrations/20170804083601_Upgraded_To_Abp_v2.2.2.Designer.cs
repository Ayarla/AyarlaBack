...
namespace Ayarla.Migrations
{
    ...
    partial class Upgraded_To_Abp_v222
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Ayarla.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Ayarla.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Ayarla.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Ayarla.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("Ayarla.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Ayarla.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
